...
void Renderer::onEvent(Events::Event& e)
{
...
void Renderer::drawFrame()
{
	...
	info.renderArea.extent.width = EngineSettings::getSingleton().getWindow_width();
	info.renderArea.extent.height = EngineSettings::getSingleton().getWindow_height();
...
void Renderer::bindUI(UserInterface* UI)
{
	drawUi = true;
	ui = UI;
}
...
void Renderer::initWindow()
{
	...
	window = glfwCreateWindow(EngineSettings::getSingleton().getWindow_width(), EngineSettings::getSingleton().getWindow_height(), "Dog Game", nullptr, nullptr);
