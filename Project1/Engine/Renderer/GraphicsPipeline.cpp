...
GraphicsPipeline::GraphicsPipeline(VkDevice& logicalDevice, RenderPassComponent& renderPassComponent, VkDescriptorSetLayout& descriptorSetLayout, VkExtent2D& swapChainExtent, std::string vertexShader, std::string fragmentShader, DepthBufferComponent* depthComponent, bool cullingEnabled) :
...
GraphicsPipeline::GraphicsPipeline(VkDevice& logicalDevice, RenderPassComponent& renderPassComponent, VkDescriptorSetLayout& descriptorSetLayout, VkExtent2D& swapChainExtent, std::string vertexShader, std::string fragmentShader, DepthBufferComponent* depthComponent, bool cullingEnabled, float lineWidth) :
	rm_logicalDevice(logicalDevice),
	rm_renderPassComponent(renderPassComponent),
	rm_descriptorSetLayout(descriptorSetLayout),
	rm_swapChainExtent(swapChainExtent),
...
GraphicsPipeline::GraphicsPipeline(VkDevice& logicalDevice, RenderPassComponent& renderPassComponent, VkDescriptorSetLayout& descriptorSetLayout, VkExtent2D& swapChainExtent, std::string vertexShader, std::string fragmentShader, DepthBufferComponent* depthComponent) :
	rm_logicalDevice(logicalDevice),
	rm_renderPassComponent(renderPassComponent),
	rm_descriptorSetLayout(descriptorSetLayout),
	rm_swapChainExtent(swapChainExtent),
