...
//PipelineBuilder::PipelineResources* PipelineBuilder::createPipeline(VkDevice& logicalDevice, VkRenderPass& renderPass, std::vector<VkPipelineShaderStageCreateInfo>& shaderStages, VkExtent2D& windowExtent, VkDescriptorSetLayout* layout, VkPushConstantRange* range, bool depthEnabled, bool cullingEnabled, bool isLine)
//{
