...
#include "VulkanDebugDrawManager.h"
...
VulkanDebugDrawManager::VulkanDebugDrawManager() :
	DebugDrawManager(),
	scene_(Scene::getSingletonPtr())
{
//	VkDevice& logicalDevice, VkRenderPass& renderPass, VmaAllocator& allocator, VkDescriptorPool& descriptorPool
	msSingleton = this;
	...
	VkDescriptorPool descriptorPool = renderer->debugDescriptorPool_;
...
void VulkanDebugDrawManager::recreateDebugDrawManager(VkDevice& logicalDevice, VkRenderPass& renderPass, VkDescriptorPool& descriptorPool)
{
	{
		std::vector<char> vertexShaderCode = ShaderUtils::readShaderFile("./shaders/debug.vert.spv");
		std::vector<char> fragmentShaderCode = ShaderUtils::readShaderFile("./shaders/debug.frag.spv");
...
void VulkanDebugDrawManager::renderFrame(const VkCommandBuffer& currentBuffer, const int currentImageIndex)
{
...
bool VulkanDebugDrawManager::getSelectedObject(int& id)
{
...
/*
 ...
 p3-------------p4
*/
void VulkanDebugDrawManager::drawFilledRect(glm::vec3 pos, const glm::vec3& color, glm::vec3& axisOfRotation, const float rotationAngle, const float minX, const float maxX, const float minY, const float maxY, int uniqueId)
{
...
void VulkanDebugDrawManager::drawCube(glm::vec3 pos, glm::vec3 size, glm::vec3 color)
{
...
/*
 ...
 p3-------------p4
*/
void VulkanDebugDrawManager::drawRect(glm::vec3 pos, glm::vec3 color, float minX, float maxX, float minY, float maxY)
{
...
p1 --------------- p2
*/
void VulkanDebugDrawManager::drawLine(glm::vec3 fromPos, glm::vec3 toPos, glm::vec3 color)
{
...
void VulkanDebugDrawManager::drawGrid(const glm::vec3& position, const glm::vec3& axisOfRotation, const float rotationAngle, const int width, const int height, const glm::vec3& color)
{
